...
VIDEOS = {
  ...
  "investor": {
    "narr": [
      ...
      "But your score is a directional estimate, not the final number. At your level, small differences in margin, recurring revenue, or how the books are kept can move your real valuation by a meaningful amount.",
    ...
    "scenes": [
      ...
      {"kicker":"Your Score Is A Starting Point","h":"A Directional<br><span class='o'>Estimate</span>","sub":"Small differences in margin, recurring revenue, or clean books can move your real number."},
  ...
  "value": {
    "narr": [
      ...
      "Your score is a directional estimate. Businesses in your range can move significantly by improving a few key things: reducing how much the business depends on you, growing recurring revenue, and documenting how the work gets done.",
  ...
  "foundation": {
    "narr": [
      ...
      "Your score is a directional estimate. The most common gap we see here is customer concentration: when too much revenue rides on one or two clients, your value takes a hit.",
  ...
  "early": {
    "narr": [
      ...
      "Your score is a directional estimate. Right now your business is likely valued close to its revenue, which means almost every improvement you make from here has outsized impact on its worth.",
  ...
  "main": {
    "narr": [
      ...
      "You'll get an estimated valuation range, your readiness score, and the specific drivers that move your number: owner dependency, recurring revenue, customer concentration, and more.",
      "It's a directional estimate, not a formal appraisal. The precise number, and your roadmap to grow it, come from a complimentary strategy call.",
    ...
    "scenes": [
      ...
      {"kicker":"What You Get","h":"An Estimated Range &amp;<br><span class='o'>Readiness Score</span>","tags":["Owner dependency","Recurring revenue","Concentration"]},
      {"kicker":"Then The Real Number","h":"A Directional Estimate —<br><span class='o'>Refined On Your Call</span>","sub":"The precise valuation and your roadmap come from a complimentary strategy call."},
